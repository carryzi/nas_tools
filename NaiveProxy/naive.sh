...
config() {
    ...
    wget -c https://raw.githubusercontent.com/carryzi/nas_tools/main/NaiveProxy/html.tar.gz -O - | tar -xz -C /var/www/
    # 生成密码
...
optimize(){
    curl https://raw.githubusercontent.com/carryzi/nas_tools/main/NaiveProxy/optimize.sh | bash -
}
...
shell_renew(){
    curl -o /root/.naive.sh https://raw.githubusercontent.com/carryzi/nas_tools/main/NaiveProxy/naive.sh 
